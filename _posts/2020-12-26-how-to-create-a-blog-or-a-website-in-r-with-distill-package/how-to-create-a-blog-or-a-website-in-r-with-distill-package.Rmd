...
categories:
  - R & the Web
  - videos
preview: images/distill_logo.png
output:
...
## 1. Create your blog either manually with RStudio or with one line of code
...
## 2. Install *Distill* and *usethis* packages
