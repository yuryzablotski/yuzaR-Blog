...
The term ‘bootstrapping,’ due to Efron (1979), is an allusion to the expression ‘pulling oneself up by one’s bootstraps’. For data it simply means - resampling. It is **necessary to resample with replacement, because we would otherwise simply reproduce the original sample**.
