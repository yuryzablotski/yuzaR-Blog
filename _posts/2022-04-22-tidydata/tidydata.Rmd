---
title: "Tidy data (in progress)"
description: |
  Tidy data are easy to manipulate, visualise and analyse, while messy data always interrupts the analysis and invates mistakes. So, tidying up data before analysis pays off a great deal in the long term. But how do we tidy up data?
author:
  - name: Yury Zablotski
...
-   a think to remember is that statistics has no good taste, thus simple is better then beautiful:
