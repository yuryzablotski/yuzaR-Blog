---
title: "4 Reasons Non-Parametric Bootstrapped Regression (with tidymodels) is Better then Ordinary"
description: |
...
- we first creat 1000 resamples of our data,
...
**new age**, just data of age from 22 to 71 years old, and call them new in order to evaluate our predictions
...
- and even when the CIs of both models match at the end of life, lower bootstrapped median estimates reflect lower salaries better compare to the mean of the ordinary model.
