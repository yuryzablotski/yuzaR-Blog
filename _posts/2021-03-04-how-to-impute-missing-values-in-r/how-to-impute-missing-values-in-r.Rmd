---
title: "How to impute missing values in R"
description: |
  Imputation simply means - replacing a missing value with a value that makes sense. But how can we get such values? Well, we'll use Machine Learning algorithms, because they have a high prediction power. So, in this video we'll learn how to impute missing values easily and effectively.
author:
  - name: Yury Zablotski
...
So, the *dlookr* package is **sweet** for a quick and controllable imputation! And I do talk about it more in the separate *dlookr* video. But we can go one step further using the *missRanger* package, which is **a real heavyweight** in data imputation!
...
ggplot()+
  ...
  theme_minimal()
```
That's it for today. If you found this useful and want to see more, feel free to like and subscribe. As always - thank for watching!, and I'll catch you again soon in the next video.
