...
ggplot(d, aes(predictor, outcome)) + 
  ...
  geom_line(aes(y = fitted(mr, dpar = "mu")[,1], color = "brm"))
```
...
- The best introduction on QR!!! https://nguyenvantien0405.files.wordpress.com/2014/03/quantile_regressiolingxin-hao.pdf 
