...
## This post as a video (not published yet)
...
The last thing which makes using plain correlation matrix statistically dangerous is that you have multiple comparisons without adjusting p-values for then, which again, increases the probability to find nonsense. A {grouped_ggcorrmat} function from {ggstatsplot} package helps with that. Within this function your can specify only 3 argument to get all the results:
