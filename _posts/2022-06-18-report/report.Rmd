---
title: "R package reviews {report} How To Report Results!"
description: |
  If you ever wandered how to correctly describe the results of statistical tests and models, this video is for you. In a few minutes you'll learn how to report the results of correlations, t-tests, Generalised Linear Models, Mixed-Effects models, Bayesian Models and even more 😉 So, let's start with a simple t-test.
author:
  - name: Yury Zablotski
