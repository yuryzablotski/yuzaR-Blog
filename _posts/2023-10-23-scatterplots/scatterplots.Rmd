...
# 6. Multivariate Exploratory Analysis (MEA 🐐) to tell a compelling story

Now, since "color" provided completely new information to our two-dimensional plot, we could see "color" argument as a third dimension. Similarly, we can introduce five additional dimensions, which will transform a simple scatter plot into a captivating narrative. Think of it as a form of Multivariate Exploratory Analysis (MEA 🐐), but without the complexity of hardcore statistics. And here is how.
