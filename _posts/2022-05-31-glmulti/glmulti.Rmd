...
description: |
  “All models are wrong, some are useful” - said a statistician George Box. And he was right. Thus, in this post we'll find the set of very useful models from the set of all possible models and will be able to choose THE MOST USEFUL model which adressed all our questions.
author:
  - name: Yury Zablotski
...
<!-- For instance, for 5 numeric predictors with interactions in "mtcars" dataset  the exhaustive screening (method = "h") takes ca. 105 seconds. Genetic algorithm (method = "g"), however, is twice as quick, with only 40-60 seconds.  -->
...
<!-- - Argument **exclude** excludes (main effects or interactions) from the candidate models, e.g. c("mass:height") ... it somehow did not work in my code and I could not find out why. -->
