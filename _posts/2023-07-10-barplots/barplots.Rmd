---
title: "(in progress) Epic Bar Plots with {ggplot2}"
description: |
...
But wait, there's more – we can actually determine the labels themselves by simply writing them down! And you won't believe this – we can make those labels bold! (foto лысого жирного чувака, уже есть :)
